...
const AboutUs = () => {
    return (
        <div className=" text-my-blue">
            ...
            <p>Bangladesh, with Dhaka at the heart of it, is a country that has become a wonder for quite a few people with its rapid economic growth in the last 10 years or so. Companies, organizations and various businesses have become the driving force for the economic development of this country. Event management services in Dhaka, Chittagong, Coxs Bazar and in the whole Bangladesh is becoming more and more common. We at Dhaka Event Planner believe that it is our responsibility as an event management company to deliver our services to our clients with reliability, dependability and creativity. We want you to remember the events that we get to manage for you. We thrive to mix and match the best styles and themes for your events. With so many events happening in Dhaka and all over Bangladesh, we believe that it is very important that you stand out with your events as our client.</p>
        </div>
    );
};
